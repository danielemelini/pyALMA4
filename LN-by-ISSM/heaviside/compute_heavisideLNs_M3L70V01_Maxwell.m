% Computes the vielastic LNs for the M3-L70-V01 test suite model, invoking ISSM
...
md.miscellaneous.name='heavisideLNs_M3L70V01_Maxwell';
...
%md.love.time=(logspace(0,5.3, 30))'*yts;
...
for j=1:6
    switch j
        ...
        case 1
            n = n_load; y = h_load;  f='h-load-heaviside-M3L70V01-Maxwell-incompressible.dat'; lab='h'; load='loading';
        case 2
            n = n_load; y = l_load;  f='l-load-heaviside-M3L70V01-Maxwell-incompressible.dat'; lab='l'; load='loading';
        case 3 
            n = n_load; y = k_load;  f='k-load-heaviside-M3L70V01-Maxwell-incompressible.dat'; lab='k'; load='loading';
        case 4
            n = n_load; y = hc_load; f='h-load-heaviside-M3L70V01-Maxwell-compressible.dat';   lab='h'; load='loading';
        case 5
            n = n_load; y = lc_load; f='l-load-heaviside-M3L70V01-Maxwell-compressible.dat';   lab='l'; load='loading';
        case 6 
            n = n_load; y = kc_load; f='k-load-heaviside-M3L70V01-Maxwell-compressible.dat';   lab='k'; load='loading';
    end
